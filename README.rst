...
- `Get all active stations <https://github.com/clairBuoyant/pybuoy/blob/main/docs/examples/get_activestations.py>`_.

- `Get realtime meteorological data <https://github.com/clairBuoyant/pybuoy/blob/main/docs/examples/get_realtime_data.py#L12>`_ for buoy by station_id.

- `Get realtime wave summary data <https://github.com/clairBuoyant/pybuoy/blob/main/docs/examples/get_realtime_data.py#L59>`_ for buoy by station_id.
